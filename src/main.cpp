...
const int servoIDs[SERVO_COUNT] = {50, 77, 88, 99, 110, 100};
...
void servo_control_task(void *parameter) {
  ...
  //  Serial.begin(115200);   //CDC
  // // 初始化舵机串口，使用GPIO43(TX)和GPIO44(RX) D6 D7
  Serial1.begin(1000000, SERIAL_8N1, S_RXD, S_TXD); 
  st.pSerial = &Serial1;

  // 定期发送测试数据到舵机
  while(1) {
    st.WritePosEx(77, 4095, 3400, 50);  // 移动到位置4095
    vTaskDelay(pdMS_TO_TICKS(1000));
    
    st.WritePosEx(77, 2000, 1500, 50);  // 移动到位置2000
    vTaskDelay(pdMS_TO_TICKS(1000));
